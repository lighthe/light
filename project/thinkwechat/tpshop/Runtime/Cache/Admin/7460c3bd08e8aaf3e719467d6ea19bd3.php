...
<div class="col-lg-12 ">
    <div class="input-group input-group-sm col-lg-7 " style="margin: 0 auto;">
        <span class="input-group-addon btn btn-success" id="sizing-addon3">搜索</span>
        <input type="text" class="form-control" placeholder="商品搜索" aria-describedby="sizing-addon3">
    </div>
<ul class="nav nav-tabs" style="margin-top: 10px;">
    <li role="presentation " class="active"><a href="#">商品列表</a></li>
    <li role="presentation "><a href="<?php echo u('admin/goods/add');?>">添加商品</a></li>
    <li role="presentation "><a href="#" style="margin-right:10px; "><?php echo ($oldData['show']); ?></a></li>
    ...
    <table class="table table-hover">
        ...
        <?php if(is_array($oldData['pageData'])): foreach($oldData['pageData'] as $key=>$vo): ?><tr>
            <th><?php echo ($vo['gid']); ?></th>
            <th><?php echo ($vo['gname']); ?></th>
            <th>

                    <li>市场价：<del>¥<?php echo ($vo['marketprice']); ?></del></li>
                    <li>商城价：<span>¥<?php echo ($vo['shopprice']); ?></span></li>

            </th>
            <th><?php echo ($vo['click']); ?></th>
            <th><?php echo date('Y-m-d H:d',$vo['time']);?></th>
            <th>
                <button data-toggle="dropdown" class="btn btn-primary btn-xs dropdown-toggle">操作 <span class="caret"></span></button>

                <ul class="dropdown-menu dropdown-menu-right">

                    <li><a href="<?php echo u('admin/goodslist/index',['gid'=>$vo['gid']]);?>">货品列表</a></li>

                    <li><a href="<?php echo u('admin/goods/edit',['gid'=>$vo['gid']]);?>">编辑</a></li>

                    <li class="divider"></li>

                    <li><a href="<?php echo u('admin/goods/del',['gid'=>$vo['gid']]);?>">删除</a></li>

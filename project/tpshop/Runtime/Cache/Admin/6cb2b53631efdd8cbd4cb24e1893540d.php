...
<div class="col-lg-12">
    ...
    <div class="panel panel-default">
        <div class="panel-heading">  货品列表</div>
        <div class="panel-body">
            <form action="<?php echo u('admin/goodslist/add');?>" method="POST" role="form">
                <table class="table table-hover">
                    <thead>
                    <tr>
                        <th>编号</th>
                        <?php if(is_array($data)): foreach($data as $k=>$vo): ?><th><?php echo ($k); ?></th><?php endforeach; endif; ?>
                        <th>货号</th>
                        <th>货存</th>
                        <th>操作</th>
                    </tr>
                    ...
                    <tbody>
                    <?php if(is_array($listData)): foreach($listData as $v=>$o): ?><tr>
                            <td><?php echo ($o['glid']); ?></td>

                            <?php if(is_array($o['combine'])): foreach($o['combine'] as $vv=>$oo): ?><td><?php echo ($oo); ?></td><?php endforeach; endif; ?>

                            <td><?php echo ($o['number']); ?></td>
                            <td><?php echo ($o['inventory']); ?></td>
                            <td>
                                <div class="btn-group">
                                    ...
                                    <ul class="dropdown-menu dropdown-menu-right">
                                        ...
                                        <li><a href="<?php echo u('edit',['gid'=>I('get.gid'),'glid'=>$o['glid']]);?>">编辑</a></li>

                                        <li class="divider"></li>

                                        <li><a href="<?php echo u('del',['gid'=>I('get.gid'),'glid'=>$o['glid']]);?>">删除</a></li>
                    ...
                    <tr>
                        ...
                        <?php if(is_array($data)): foreach($data as $b=>$a): ?><td>
                                <select name="combine[]"  class="form-control">
                                    <option value=""> -- Select One -- </option>
                                    <?php if(is_array($a)): foreach($a as $d=>$c): ?><option value="<?php echo ($c['gtid']); ?>"> --<?php echo ($c['gtvalue']); ?> -- </option><?php endforeach; endif; ?>
                                </select>

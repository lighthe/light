...
<div class=" col-lg-12">
    ...
    <div class="panel panel-default">
        ...
        <div class="panel-heading">
            <div class="btn-group">
                <a href="<?php echo u('admin/category/topCate');?>" type="button" class="btn btn-primary">添加顶级分类</a>
            </div>
        </div>
        <div class="panel-body">
            ...
            <table class="table table-hover">
                ...
                <tbody>
                <?php if(is_array($cData)): $i = 0; $__LIST__ = $cData;if( count($__LIST__)==0 ) : echo "" ;else: foreach($__LIST__ as $key=>$vo): $mod = ($i % 2 );++$i;?><tr>
                    <td><?php echo ($vo['cid']); ?></td>
                    <td><?php echo ($vo['_cname']); ?></td>
                ...
                <?php }?>
                    <td>
                        <div class="btn-group">
                            <a href="<?php echo u('admin/category/sonCate',['cid'=>$vo['cid']]);?>" type="button" class="btn btn-default">添加子类</a>
                            <a href="<?php echo u('admin/category/editCate',['cid'=>$vo['cid']]);?>" style="margin-left: 5px;" type="button" class="btn btn-success">编辑</a>
                            <a  href="<?php echo u('admin/category/del',['cid'=>$vo['cid']]);?>" style="margin-left: 5px;" type="button" class="btn btn-danger">删除</a>
                        </div>
                    </td>

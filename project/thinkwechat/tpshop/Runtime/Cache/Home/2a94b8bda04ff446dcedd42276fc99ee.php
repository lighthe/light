...
<div class="banner">
    <ul class="pic">
        <li style="background: url(/Public/Home/images/1.webp.jpg) no-repeat center center;">
            <a href=""></a>
        </li>
        <li style="background: url(/Public/Home/images/2.webp.jpg) no-repeat center center;">
            <a href=""></a>
        </li>
        <li style="background: url(/Public/Home/images/3.webp.jpg) no-repeat center center;">
            <a href=""></a>
        </li>
        <li style="background: url(/Public/Home/images/4.webp.jpg) no-repeat center center;">
            <a href=""></a>
        </li>
        <li style="background: url(/Public/Home/images/5.webp.jpg) no-repeat center center;">
            <a href=""></a>
        </li>
...
<div id="content">
    <div class="main">
        <div class="tip">
            <ul>
                <?php if(is_array($hot)): foreach($hot as $key=>$vo): ?><li style="text-align: center">
                    <a style="color:#666;" href="<?php echo u('Home/listPage/listPage',['cid'=>$vo['cid']]);?>"><img width="100%" height="85%" src="/<?php echo ($vo['pic']); ?>" alt="" /><?php echo ($vo['gname']); ?></a>
                </li><?php endforeach; endif; ?>
        ...
        <ul class="part-container">
            <li class="ac0">
                <a href="" target="_blank"> <img class="js-lazyload" src="/Public/Home/images/1.webp"> </a>
            </li>
            <li class="ac1">
                <a href="" target="_blank"> <img class="js-lazyload" src="/Public/Home/images/2.webp"> </a>
            </li>
            <li class="ac2">
                <a href="" target="_blank"> <img class="js-lazyload" src="/Public/Home/images/3.webp"> </a>
            </li>
            <li class="ac3">
                <a href="" target="_blank"> <img class="js-lazyload" src="/Public/Home/images/4.webp"> </a>
            </li>
            <li class="ac4">
                <a href="" target="_blank"> <img class="js-lazyload" src="/Public/Home/images/5.webp"> </a>
            </li>
            <li class="ac5">
                <a href="" target="_blank"> <img class="js-lazyload" src="/Public/Home/images/1.webp"> </a>
            </li>
        ...
        <div class="container" id="floor1">
            <div class="part-title"><?php echo ($cellphone['cname']); ?></div>
            <div class="part-hot">
                ...
                <ul>
                    ...
                    <?php if(is_array($cellphone['_data'])): foreach($cellphone['_data'] as $key=>$vo): $a++;?>
                        <?php  if($a<4){ ?>
                    <li>
                        <a href="<?php echo u('Home/listPage/listPage',['cid'=>$vo['cid']]);?>" target="_blank"><?php echo ($vo['cname']); ?></a>
                    </li>
                        <!--如果去掉最后一个-->
                    <li>|</li>
            ...
            <a href="<?php echo u('Home/listPage/listPage',['cid'=>1]);?>" target="_blank" class="indexmore">更多</a>
        </div>
        ...
        <div class="container">
            <div class="part-left">
                <a class="part-left1" href="#" target="_blank">
                    <img src="/Public/Home/images/flot1.webp">
                </a>
                <a class="part-left2" href="" target="_blank">
                    <img src="/Public/Home/images/shouji.webp">
                </a>
            </div>
            <div class="part-center">
                <?php $i=0;?>

                <?php if(is_array($cellphone['_data'])): foreach($cellphone['_data'] as $key=>$vo): $i++;?>
                    <?php  if($i<7){ ?>
                <ul>
<!-手机--->
                    <li>
                        <a href="<?php echo u('Home/listPage/listPage',['cid'=>$vo['cid']]);?>">
                            <span class="title"><?php echo ($vo['gname']); ?></span>
                            <span class="info">市场价: <?php echo ($vo['marketprice']); ?></span>
                            <span class="price">商城价:<?php echo ($vo['price']); ?></span>
                            <img width="150px"  src="/<?php echo ($vo['pic']); ?>" alt="" />
                        </a>
                    </li>
                </ul>
               <?php } endforeach; endif; ?>
            ...
            <div class="part-right">
                ...
                <div class="slideBox">
                    <div class="slider-film">
                        ...
                        <a href="<?php echo u('Home/listPage/listPage',['cid'=>$vo['cid']]);?>">
                            <dl>
                                <dt><img src="/<?php echo ($vo['pic']); ?>" > </dt>
                                <dd class="title"><?php echo ($vo['gname']); ?></dd>
                                <dd class="info">市场价: <?php echo ($vo['marketprice']); ?> </dd>
                                <dd class="price"><i class="yen">￥</i><?php echo ($vo['price']); ?></dd>
                            </dl>
                        </a>
                            <?php } endforeach; endif; ?>
...
<!--手表-->
        ...
        <div class="container" id="floor2">
            <div class="part-title"><?php echo ($watchs['cname']); ?></div>
            <div class="part-hot">
                <span class="hotsou">热搜：</span>
                <ul>
                    ...
                    <?php if(is_array($watchs['_data'])): foreach($watchs['_data'] as $key=>$vo): $a++;?>
                        <?php  if($a<4){ ?>
                        <li>
                            <a href="<?php echo u('Home/listPage/listPage',['cid'=>$vo['cid']]);?>" target="_blank"><?php echo ($vo['cname']); ?></a>
                        </li>
            ...
            <a href="<?php echo u('Home/listPage/listPage',['cid'=>2]);?>" target="_blank" class="indexmore">更多</a>
        </div>
        <div class="container">
            <div class="part-left">
                <a class="part-left1" href="#" target="_blank">
            ...
            <div class="part-center">
                <ul>
                    ...
                    <?php $d=0;?>
                    <!---->
                    <?php if(is_array($watchs['_data'])): foreach($watchs['_data'] as $key=>$vo): $d++;?>
                        <?php  if($d<7){ ?>
                    <li>
                        <a href="<?php echo u('Home/listPage/listPage',['cid'=>$vo['cid']]);?>">
                            <span class="title"><?php echo ($vo['gname']); ?></span>
        ...
        <div class="container" id="floor3">
            <div class="part-title">360手机</div>
            <div class="part-hot">
                <span class="hotsou">热搜：</span>
                <ul>
                    <?php $a=0;?>
                    <?php if(is_array($rout['_data'])): foreach($rout['_data'] as $key=>$vo): $a++;?>
                        <?php  if($a<4){ ?>
                        <li>
                            <a href="<?php echo u('Home/listPage/listPage',['cid'=>$vo['cid']]);?>" target="_blank"><?php echo ($vo['cname']); ?></a>
                        </li>
            ...
            <a href="<?php echo u('Home/listPage/listPage',['cid'=>3]);?>"  class="indexmore">更多</a>
        </div>
        <div class="container">
            <div class="part-left">
                <a class="part-left1" href="#" target="_blank">
            ...
            <div class="part-center">
                <ul>
                    ...
                    <?php $e=0;?>
                    <!---->
                    <?php if(is_array($rout['_data'])): foreach($rout['_data'] as $key=>$vo): $e++;?>
                        <?php  if($e<5){ ?>
                        <li>
                            <a href="<?php echo u('Home/listPage/listPage',['cid'=>$vo['cid']]);?>">
                                <span class="title"><?php echo ($vo['gname']); ?></span>
            ...
            <div class="part-right">
                ...
                <div class="slideBox">
                    <div class="slider-film">
                        ...
                        <?php $d=0;?>
                        <!---->
                        <?php if(is_array($rout['_data'])): foreach($rout['_data'] as $key=>$vo): $d++;?>
                            <?php  if($d<5){ ?>
                            <a href="<?php echo u('Home/listPage/listPage',['cid'=>$vo['cid']]);?>">
                                <dl>
                                    <dt><img src="/<?php echo ($vo['pic']); ?>" > </dt>
...
<!---->
        ...
        <div class="container" id="floor4">
            <div class="part-title"><?php echo ($car['cname']); ?></div>
            <div class="part-hot">
                <span class="hotsou">热搜：</span>
                <ul>
                    <?php $a=0;?>
                    <?php if(is_array($car['_data'])): foreach($car['_data'] as $key=>$vo): $a++;?>
                        <?php  if($a<4){ ?>
                        <li>
                            <a href="<?php echo u('Home/listPage/listPage',['cid'=>$vo['cid']]);?>" target="_blank"><?php echo ($vo['cname']); ?></a>
                        </li>
            ...
            <a href="<?php echo u('Home/listPage/listPage',['cid'=>4]);?>" target="_blank" class="indexmore">更多</a>
        </div>
        <div class="container">
            <div class="part-left">
                <a class="part-left1" href="#" target="_blank">
            ...
            <div class="part-center">
                <ul>
                    ...
                    <?php $e=0;?>
                    <!---->
                    <?php if(is_array($car['_data'])): foreach($car['_data'] as $key=>$vo): $e++;?>
                        <?php  if($e<5){ ?>
                        <li>
                            <a href="<?php echo u('Home/listPage/listPage',['cid'=>$vo['cid']]);?>">
                                <span class="title"><?php echo ($vo['gname']); ?></span>
            ...
            <div class="part-right">
                ...
                <div class="slideBox">
                    <div class="slider-film">
                        ...
                        <?php $d=0;?>
                        <!---->
                        <?php if(is_array($car['_data'])): foreach($car['_data'] as $key=>$vo): $d++;?>
                            <?php  if($d<5){ ?>
                            <a href="<?php echo u('Home/listPage/listPage',['cid'=>$vo['cid']]);?>">
                                <dl>
                                    <dt><img src="/<?php echo ($vo['pic']); ?>" > </dt>
        ...
        <div class="newproduct" id="newproduct">
            ...
            <ul class="newproduct-list">
                <?php if(is_array($all)): foreach($all as $key=>$vo): ?><li>
                    <a href="" class="new-item">
                        <dl>
                            <dt><img class="js-lazyload" src="/<?php echo ($vo['pic']); ?>"></dt>
                            <dd class="title">市场价:<?php echo ($vo['marketprice']); ?> </dd>
                            <dd class="price"><span><i class="yen">￥</i><?php echo ($vo['shopprice']); ?></span><?php echo date(' m-d',$vo['time']);?>上新</dd>
                        </dl>
                    </a>
                </li><?php endforeach; endif; ?>
            </ul>

        ...
        <div class="panel panel-default">
            ...
            <div class="panel-body">
                    ...
                    <div class="col-sm-9">
                        <foreach from="$tagData"  key ="$k" value="$v">
                            <label class="checkbox-inline">
                                <input  type="checkbox" name="tag[]"  <if value="in_array($v['tid'],$oldTag)" >checked</if> value="{{$v['tid']}}">{{$v['tname']}}
                            </label>
                        </foreach>
                    </div>
                </div>
                ...
                <div class="form-group">
                    ...
                    <div class="col-sm-9">
                        <textarea name="content" id="container" style="height:300px;width:100%;">{{$oldData['content']}}</textarea>
                        <script>

...
<div class="m-b-md">
    <h3 class="m-b-none">关键词列表</h3>
</div>
<div class="row">
    <div class="col-sm-12">
        <section class="panel panel-default">
            <header class="panel-heading font-bold">关键词列表</header>
            <div class="panel-body">
                ...
                <?php if(is_array($fields)): $i = 0; $__LIST__ = $fields;if( count($__LIST__)==0 ) : echo "" ;else: foreach($__LIST__ as $key=>$vo): $mod = ($i % 2 );++$i;?><tr>
                            ...
                            <td>
                                <div class="btn-group">
                                    <a href="<?php echo u('module/keyword/set',['kid'=>$vo['kid'],'mo'=>MODULE]);?>" class="btn btn-success btn-xs">编辑</a>
                                    <a href="<?php echo u('module/keyword/del',['kid'=>$vo['kid'],'mo'=>MODULE]);?>" class="btn btn-danger btn-xs">删除</a>
                                </div>
                            </td>
...
<div class="btn-group">
    <a href="<?php echo u('module/keyword/set',['mo'=>MODULE]);?>" class="btn btn-success">添加关键词</a>
</div>
                    </section>
                </section>

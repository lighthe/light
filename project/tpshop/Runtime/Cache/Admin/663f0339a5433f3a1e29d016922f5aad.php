...
<div class="col-lg-12">
    ...
    <div class="panel panel-default">
        ...
        <div class="panel-heading">
            <a  href="<?php echo u('admin/logo/add');?>" type="button" class="btn btn-primary">添加品牌</a>
        </div>
        <div class="panel-body">
            ...
            <?php if(is_array($data['pageData'])): $i = 0; $__LIST__ = $data['pageData'];if( count($__LIST__)==0 ) : echo "" ;else: foreach($__LIST__ as $key=>$vo): $mod = ($i % 2 );++$i;?><tr>
                    ...
                    <td>
                        ...
                        <img src="/<?php echo ($vo['logo']); ?>" width="50px">

                    </td>

                    <td><?php echo ($vo['lhot']); ?></td>
                    <td><?php echo ($vo['lsort']); ?></td>


                    <?php if($vo['l_show']): ?><td style="color: red;">不显示</td>
                        <?php else: ?>
                    <td>显示</td><?php endif; ?>
                    ...
                    <td>
                        ...
                        <div class="btn-group">
                            ...
                            <ul class="dropdown-menu dropdown-menu-right">
                                ...
                                <li><a href="<?php echo u('admin/logo/edit',['lid'=>$vo['lid']]);?>">编辑</a></li>

                                <li class="divider"></li>

                                <li><a href="<?php echo u('admin/logo/del',['lid'=>$vo['lid']]);?>">删除</a></li>

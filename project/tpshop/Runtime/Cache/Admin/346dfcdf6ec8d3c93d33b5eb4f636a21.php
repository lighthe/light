...
<section class="vbox">
    ...
    <div class="col-lg-12 ">
        ...
        <ul class="nav nav-tabs" style="margin-top: 10px;">
            ...
            <li role="presentation " class="active"><a href="<?php echo u('admin/goods/add');?>">添加商品</a></li>
            ...
            <div class="panel-body">
                <form class="form-horizontal" method="post" action=""  onsubmit="return store(this);">
                        ...
                        <div class="col-sm-6">
                            <select name="cid" class="form-control m-b">
                                ...
                                <?php if(is_array($cateData)): $i = 0; $__LIST__ = $cateData;if( count($__LIST__)==0 ) : echo "" ;else: foreach($__LIST__ as $key=>$vo): $mod = ($i % 2 );++$i;?><!--这里我们要将被选择的元素的值拿到-->
                                    <option value="<?php echo ($vo['cid']); ?>" tid="<?php echo ($vo['tid']); ?>" ><?php echo ($vo['_cname']); ?></option><?php endforeach; endif; else: echo "" ;endif; ?>
                                    <!--用ajax抓取option的值-->
                            </select>
                        </div>
                    </div>
                    ...
                    <div class="form-group">
                        ...
                        <div class="col-sm-6">
                            <select name="lid" class="form-control m-b">
                                ...
                                <?php if(is_array($brandData)): $i = 0; $__LIST__ = $brandData;if( count($__LIST__)==0 ) : echo "" ;else: foreach($__LIST__ as $key=>$qq): $mod = ($i % 2 );++$i;?><option value="<?php echo ($qq['lid']); ?>"><?php echo ($qq['lname']); ?></option><?php endforeach; endif; else: echo "" ;endif; ?>
                            </select>
                        </div>
                    </div>
                    <div class="line line-dashed line-lg pull-in"></div>
                                    ...
                                    require(['util'], function (util) {
                                        ...
                                        util.image(function (images) {
                                            $(images).each(function(k,v){
                                                $("<li><img style='width: 80px; margin-left: 3px; float: right;' src='/"+v+"'/><input type='hidden' name='img[]' value='"+v+"'><a href='javascript:;' class='delImg' >X</a></li>").appendTo('#box');
                                            })
                                        }, options)
                                    });
                                }
                    ...
                    <div class="form-group">
                        ...
                        <div class="col-sm-7">
                            <textarea id="container2" style="height:300px;width:100%;" name="service"></textarea>
                            <script>
    ...
    <script type="text/javascript">
            function store(obj){
              ...
              $.post("<?php echo u(admin/goods/add);?>",data,function (res) {

        ...
        <section class="panel panel-default">
            ...
            <div class="panel-body">
                <table class="table table-hover">
                    ...
                    <tbody>
                    <?php if(is_array($module)): $i = 0; $__LIST__ = $module;if( count($__LIST__)==0 ) : echo "" ;else: foreach($__LIST__ as $key=>$vo): $mod = ($i % 2 );++$i;?><tr>
                            <td><?php echo ($vo['name']); ?></td>
                            <td><?php echo ($vo['title']); ?></td>
                            <td>
                                <div class="btn-group">
                                    <?php if(!in_array($vo['title'],$has) ): ?><a href="<?php echo u('model/manger/install',['title'=>$vo['title']]);?>" class="btn btn-success btn-xs">安装</a>
                                          <?php else: ?>
                                        <a href="<?php echo u('model/manger/uninstall',['title'=>$vo['title']]);?>" class="btn btn-danger btn-xs">卸载</a><?php endif; ?>
                                </div>
                            </td>

            ...
            <div class="panel panel-default">
                ...
                <div class="panel-body">
                    <div class="form-group">
                        ...
                        <div class="col-sm-9">
                            <input type="text" name="lname"   value="{{$data['lname']}}"  class="form-control" placeholder="请填写友链名称">
                        </div>
                    </div>
                    <div class="form-group">
                        ...
                        <div class="col-sm-9">
                            <div class="input-group">
                                <input type="text" class="form-control" name="logo" readonly="" value="{{$data['logo']}}">
                    ...
                    <div class="form-group">
                        ...
                        <div class="col-sm-9">
                            <input type="text" name="url"  value="{{$data['url']}}"  class="form-control" placeholder="">
                        </div>
                    </div>
                    <div class="form-group">
                        <label for="" class="col-sm-2 control-label">排序</label>
                        <div class="col-sm-9">
                            <input type="number" name="sort"  value="{{$data['sort']}}"  class="form-control" placeholder="">
                        </div>
                    </div>
                </div>
            </div>

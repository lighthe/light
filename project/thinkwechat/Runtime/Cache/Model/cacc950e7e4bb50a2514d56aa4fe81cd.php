...
<div class="m-b-md">
    <h3 class="m-b-none">栏目列表</h3>
</div>
<div class="row">
    <div class="col-sm-12">
        <section class="panel panel-default">
            <header class="panel-heading font-bold">栏目列表</header>
                ...
                <?php if(is_array($data)): $i = 0; $__LIST__ = $data;if( count($__LIST__)==0 ) : echo "" ;else: foreach($__LIST__ as $key=>$d): $mod = ($i % 2 );++$i;?><tr>
                            ...
                            <td>
                                <div class="btn-group">
                                    ...
                                    <a href="<?php echo site_url('news.addCate',['cid'=>$d['cid']]);?>" class="btn btn-info btn-xs">编辑</a>
                                    <a href="<?php echo site_url('news.del',['cid'=>$d['cid']]);?>" class="btn btn-danger btn-xs">删除</a>
                                </div>
                            </td>
...
<div class="btn-group">
    <a href="<?php echo site_url('news.addCate');?>" class="btn btn-default">添加栏目</a>
</div>
                    </section>
                </section>

...
<div class="row">
    <div class="col-sm-12">
        <section class="panel panel-default">
            <header class="panel-heading font-bold">菜单列表</header>
            ...
            <?php if(is_array($data)): $i = 0; $__LIST__ = $data;if( count($__LIST__)==0 ) : echo "" ;else: foreach($__LIST__ as $key=>$vo): $mod = ($i % 2 );++$i;?><tr>
                            ...
                            <td>
                                <div class="btn-group">
                                        ...
                                        <a href="javascript:;" class="btn btn-success btn-xs">使用中</a>

                                        <a href="" class="btn btn-default btn-xs">推送</a>

                                    <a href="<?php echo site_url('button.add',['id'=>1]);?>" class="btn btn-info btn-xs">编辑</a>
...
<div class="btn-group">
    <a href="<?php echo site_url('button.add');?>" class="btn btn-default">添加菜单</a>
</div>
                    </section>
                </section>

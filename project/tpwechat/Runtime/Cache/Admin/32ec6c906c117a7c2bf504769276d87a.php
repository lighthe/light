        ...
        <section class="panel panel-default m-t-lg bg-white">
            ...
            <form action=""  method="post" class="panel-body wrapper-lg">
                ...
                <div class="form-group">
                    ...
                    <input type="password" id="inputPassword" placeholder="请输入登录密码"  name="password" class="form-control input-lg">
                </div>
                <div class="form-group">
                    <label class="control-label">验证码</label>
                    <input type="text" id="inputPassword" placeholder="请输入验证码"  name="code" class="form-control input-lg">
                </div>
                <img src="<?php echo u('admin/login/code');?>"  onclick="this.src=this.src+'?'+Math.random()" alt="">
                <button type="submit" class="btn btn-primary btn-block">登录</button>
                <div class="line line-dashed"></div>
                <p class="text-muted text-center"><small>何辉的微信的后台登入</small></p>

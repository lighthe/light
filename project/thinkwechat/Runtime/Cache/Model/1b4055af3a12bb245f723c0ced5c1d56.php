...
<div class="row">
    <div class="col-sm-12">
        <section class="panel panel-default">
            <header class="panel-heading font-bold">文章列表</header>
            <div class="panel-body">
                <table class="table table-hover">
                    ...
                    <tbody>
                    <?php if(is_array($oldData)): $i = 0; $__LIST__ = $oldData;if( count($__LIST__)==0 ) : echo "" ;else: foreach($__LIST__ as $key=>$d): $mod = ($i % 2 );++$i;?><tr>
                            <td><?php echo ($d['aid']); ?></td>
                            <td><?php echo ($d['title']); ?></td>
                            <td>
                                <div class="btn-group">
                                    <a href="<?php echo site_url('news.addArticle',['aid'=>$d['aid']]);?>" class="btn btn-info btn-xs">编辑</a>
                                    <a href="<?php echo site_url('news.del',['aid'=>1]);?>" class="btn btn-danger btn-xs">删除</a>
                                </div>
                            </td>
...
<div class="btn-group">
    <a href="<?php echo site_url('news.addArticle');?>" class="btn btn-default">添加栏目</a>
</div>
                    </section>
                </section>
